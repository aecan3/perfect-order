...
export const TIER_STYLES = {
  base: "bg-gradient-to-br from-stone-100 to-stone-300 text-stone-700",
  trainer: "bg-gradient-to-br from-amber-100 to-amber-300 text-amber-900",
  energy: "bg-gradient-to-br from-yellow-100 to-yellow-300 text-yellow-900",
  ex: "bg-gradient-to-br from-rose-200 to-rose-400 text-rose-950",
  illustration: "bg-gradient-to-br from-violet-200 to-fuchsia-400 text-violet-950",
  gold: "bg-gradient-to-br from-yellow-300 via-amber-400 to-yellow-600 text-amber-950",
};

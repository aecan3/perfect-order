-- Fix ambiguous column reference introduced in 20260601000002.
-- 'printing_id' in the user_owned subquery conflicted with the RETURNS TABLE
-- output variable of the same name. Renamed the CTE alias to owned_id.
